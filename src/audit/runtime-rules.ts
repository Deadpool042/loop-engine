...
import {
  ...
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_OBSERVATION_CONTRACTS_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_OBSERVATION_DEPENDENCIES_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_OBSERVATION_MATRIX_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_OBSERVATION_INVARIANTS_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_PROGRESSION_CONTRACTS_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_PROGRESSION_DEPENDENCIES_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_PROGRESSION_MATRIX_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_PROGRESSION_INVARIANTS_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_FINALIZATION_CONTRACTS_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_FINALIZATION_DEPENDENCIES_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_FINALIZATION_MATRIX_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_FINALIZATION_INVARIANTS_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_CLOSURE_PREPARATION_CONTRACTS_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_CLOSURE_PREPARATION_DEPENDENCIES_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_CLOSURE_PREPARATION_MATRIX_RULE,
  AUTOMATION_WORKER_EXECUTION_LIFECYCLE_CLOSURE_PREPARATION_INVARIANTS_RULE,

...
- Aucun nouveau lot V15+ avant une exécution réelle de `runLoopCommit` sur un projet pilote non-fixture avec message explicite, vérification du commit exact et aucune publication.

...
Governed Patch Application reste différée : à reconsidérer seulement après l'existence et la qualification d'une primitive de publication multi-fichiers atomique et récupérable dans le dépôt source. Cette capacité n'est pas livrée par V31.

...
Ce document est la source de vérité simple pour les tags stables documentés du cycle Audit Engine.
...
- `audit-engine-v6.0` est le dernier tag stable global documenté à ce jour.

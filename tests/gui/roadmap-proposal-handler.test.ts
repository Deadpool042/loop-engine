...
describe("GUI roadmap proposal handler", () => {
  it("invokes roadmap propose with the fixed provider/timeout, omitting --provider-model so the CLI auto-routes, and injects the credential only into the child env", async () => {

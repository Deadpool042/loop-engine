  ...
  it("AUTO planning narrows a governed oversized parent before agent execution", () => {
    const { project } = setupGovernedProject({
      ...
      decisionYaml: (sha) => [
        ...
        "      - Implement G3 state in src/g3/a.ts and src/g3/b.ts.",
        "      - Implement G3 continuation in src/g3/c.ts.",
        "      - Add G3 integration in src/g3/d.ts.",
        "      - Update roadmap.md candidate state.",
